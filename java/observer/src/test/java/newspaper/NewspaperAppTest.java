...
public class NewspaperAppTest {
    ...
    public void testRegisterAndNotify_NewYorkTimes() {
        ...
        assertEquals("This is a android notification from new york times!This is a iOS notification from new york times!", outputStream.toString().trim().replace("\r", "").replace("\n", ""));
    }
    ...
    public void testRegisterAndNotify_NZZ() {
        ...
        server.notifyAllCLients();
        assertEquals("This is a android notification from nzz!This is a iOS notification from nzz!", outputStream.toString().trim().replace("\r", "").replace("\n", ""));
    }
